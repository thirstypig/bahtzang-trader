...
| `/testing` | Test inventory, execution cadence, 492 tests (363 backend + 129 frontend) |
...
492 tests (363 backend + 129 frontend), all passing in ~9s. Pre-commit hook + GitHub Actions CI runs `next lint` too.
