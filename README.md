...
| `/testing` | Test inventory, execution cadence, 511 tests (382 backend + 129 frontend) |
...
511 tests (382 backend + 129 frontend), all passing in ~9s. Pre-commit hook + GitHub Actions CI runs `next lint` too.
