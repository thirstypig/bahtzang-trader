...
| `/testing` | Test inventory, execution cadence, 502 tests (373 backend + 129 frontend) |
...
502 tests (373 backend + 129 frontend), all passing in ~9s. Pre-commit hook + GitHub Actions CI runs `next lint` too.
