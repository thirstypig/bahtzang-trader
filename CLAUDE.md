...
backend/
  ...
  tests/              # Test suites (348 backend tests)
...
frontend/
  src/
    app/              # Next.js App Router pages
      ...
      testing/        # /testing (test inventory, execution cadence, 477 tests)
      audit-log/      # /audit-log
...
- 477 total tests (348 backend + 129 frontend), ~9s full suite
...
- **477 tests are the baseline.** Don't ship features that drop the count or break CI.
