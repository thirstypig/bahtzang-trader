...
backend/
  ...
  tests/              # Test suites (349 backend tests)
...
frontend/
  src/
    app/              # Next.js App Router pages
      ...
      testing/        # /testing (test inventory, execution cadence, 478 tests)
      audit-log/      # /audit-log
...
- 478 total tests (349 backend + 129 frontend), ~9s full suite
...
- **478 tests are the baseline.** Don't ship features that drop the count or break CI.
